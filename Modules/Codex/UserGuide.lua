    ...
    pages = {
...

        {
            ...
            blocks = {
                ...
                { type = "paragraph", text = "The |cffffd700Met|r tab is the items this character has actually touched: carried, worn, banked, looted, looked at on a vendor, or linked by anyone in chat. It starts empty and fills in as you play, and it is what the whole tab shows on a client with no shipped list." },
