    ...
    pages = {
...

        {
            ...
            blocks = {
                ...
                { type = "paragraph", text = "Typing a |cffffd700name|r searches |cffffd700every item in the game|r. The client cannot do that itself - there is no such call - so BazUI ships the game's own item list for WoW: Forever, generated from the game's tables, and a name looks through all of it. Type |cffffd700elixir|r and you get every elixir there is, not the ones you have happened to carry." },
                { type = "paragraph", text = "Before you type anything, the tab shows the items this character has |cffffd700met|r: what you carry, wear, bank, loot, or look at on a vendor, and anything anyone links in chat. Eighteen thousand rows is not a page anybody reads; the ones you have touched are. That list starts empty and fills in as you play." },
                ...
                { type = "paragraph", text = "A row of |cffffd700categories|r sits above the list, and they are the same categories your bags use - including any you made yourself. Pick one to narrow the list to it, or All to drop the filter. There is no fixed set written here, so a category you add in Bags turns up here as well." },
                { type = "h2", text = "The wishlist" },
                { type = "paragraph", text = "Drop an item link into the box at the top of the Wishlist tab and it joins the list, which then says how long ago you wanted it. When one turns up in your bags the row says so. Click the |cffffd700x|r on a row to take it off. Shift-clicking a row links it in chat." },
