...

        {
            ...
            blocks = {
                ...
                { type = "table", columns = { "Setting", "What it does" }, rows = {
                    ...
                    { "Background Panel", "Draws BazUI's panel behind the whole bar, the same one a flyout wears. Off by default, and set per bar." },
                ...
                { type = "paragraph", text = "For anything past that list, pick |cffffd700Custom|r and use the |cffffd700Show When|r box underneath it. |cffffd700Anything the game's macro conditions understand works|r:" },
                { type = "code", text = "[combat] show; hide" },
                { type = "paragraph", text = "So |cffffd700[stance:1]|r, |cffffd700[group]|r, |cffffd700[mod:shift]|r, |cffffd700[stealth]|r and the rest are all available." },
                ...
                { type = "table", columns = { "Action", "What it does" }, rows = {
                    ...
                    { "BazUIBars Settings", "Opens the General page: what applies to every bar at once." },
                ...
                { type = "note", text = "|cffffd700The inspector is the only place a bar is edited.|r There was a Bar Options page saying the same things, and two forms over one set of values meant whichever you did not have open was out of date. |cffffd700New bar|r is on Edit Mode's add menu; Duplicate and Delete are in the bar's own menu above." },
            },
        },
