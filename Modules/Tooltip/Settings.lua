...
BazUI:RegisterSettingsSpec("Tooltip", {
    ...
    entries = {
        ...
        { key = "point", label = "Screen corner", type = "select", section = "anchor", order = 2,
        ...
        { key = "anchorHelp", type = "note", section = "anchor", order = 7,
          text = "Default preserves existing anchors and the Drawers tooltip dock. Cursor and fixed modes override the main hover tooltip; item comparisons stay beside their item. A docked tooltip uses the drawer's fit scale." },
