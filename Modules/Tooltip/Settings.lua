...
BazUI:RegisterSettingsSpec("Tooltip", {
    ...
    entries = {
        ...
        { key = "anchorHelp", type = "note", section = "anchor", order = 7,
          text = "Tooltip origin chooses which matching corner or edge of the tooltip and anchor box meet (or the cursor offset). Changing it leaves the marker in place. Default preserves existing anchors and the Drawers tooltip dock. Cursor and fixed modes override the main hover tooltip; item comparisons stay beside their item. A docked tooltip uses the drawer's fit scale." },
