    ...
    pages = {
...

        {
            ...
            blocks = {
                ...
                { type = "table", columns = { "Setting", "What it does" }, rows = {
                    ...
                    { "Map Scale", "How much of the drawer's width the map takes. Below 100% it sits smaller and centred. For a bigger map, widen the drawer." },
...

        {
            ...
            blocks = {
                ...
                { type = "paragraph", text = "What you are wearing, with your overall average underneath. The headline turns yellow when there is something better sitting in your bags. |cffffd700Show iLevel on Item Slots|r also writes each item's level into the corner of its slot on the character pane, coloured by quality." },
