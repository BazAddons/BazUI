    ...
    pages = {
...

        {
            ...
            blocks = {
                ...
                { type = "paragraph", text = "|cffffd700Mark what to drop first|r rings the grey stack worth the least of anything you are carrying, the moment you have no free slots left, so there is no hunting for something to make room with. Hovering it says what it is worth." },
