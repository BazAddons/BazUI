...

        {
            ...
            blocks = {
                { type = "table", columns = { "Setting", "What it does" }, rows = {
                    ...
                    { "High / Normal / Low priority sound", "A sound each, for the three levels of urgency. Greyed out while sounds are off." },
...

        {
            ...
            blocks = {
                { type = "table", columns = { "Command", "What it does" }, rows = {
                    ...
                    { "/bnc scaffold <name>", "Prints a starting template for an addon of your own that reports through this centre." },
