    ...
    pages = {
        {
            ...
            blocks = {
                ...
                { type = "list", items = {
                    ...
                    "Debuff rims colored by type: blue Magic, purple Curse, brown Disease, green Poison",
                ...
                { type = "note", style = "tip", text = "Drag a row in Edit Mode and drop it near the edge of a bar to dock it there. A centered row stays centered as icons come and go, including in combat, because what moves is the row's frame rather than anything the game protects." },
            },
        },
        {
            title = "Settings",
            blocks = {
                ...
                { type = "table",
                  ...
                  rows = {
                      ...
                      { "|cffffd700Color debuff rims by type|r", "Off keeps every debuff rim red." },
                      ...
                      { "|cffffd700Aligned|r",                "Which end of its host a docked row starts from: left, center or right." },
