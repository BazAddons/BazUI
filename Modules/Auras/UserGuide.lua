    ...
    pages = {
        {
            ...
            blocks = {
                ...
                { type = "list", items = {
                    ...
                    "Debuff rims coloured by type: blue Magic, purple Curse, brown Disease, green Poison, red for everything else.",
...

        {
            ...
            blocks = {
                ...
                { type = "table", columns = { "Setting", "What it does" }, rows = {
                    ...
                    { "Aligned", "Which end of its host the row starts from: left, centre or right." },
                    { "Gap", "Pixels between this row and what it is docked to." },
                } },
                { type = "note", text = "A centred row stays centred as icons come and go, including in combat, because what moves is the row's frame rather than anything the game protects." },
            },
        },
...

        {
            ...
            blocks = {
                ...
                { type = "table", columns = { "Setting", "What it does" }, rows = {
                    ...
                    { "Colour debuff rims by type", "Off keeps every debuff rim red." },
