    ...
    pages = {
...

        {
            ...
            blocks = {
                ...
                { type = "note", text = "|cffffd700On WoW: Forever, a percentage is not always available.|r Three wordings ask for one - |cffffd700Percent|r, |cffffd700Name and percent|r and |cffffd700Everything|r - and where the game will not give it, each shows the next best thing instead: the pair of numbers, the name and level, and the name with the numbers.\n\nThe other wordings are unaffected. |cffffd700Name and percent|r is what every new bar starts on, so it is worth knowing before you go looking for a setting that is broken." },
