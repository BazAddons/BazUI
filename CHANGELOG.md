...
- Auras: your buffs above the player frame's health bar and debuffs above its power bar, and the target's below the target frame's bars, eight per row, with timers, stack counts and right-click to cancel.
