...
- Bars: custom action bars with spells, items, macros, mounts and equipment sets, quick keybinds, Edit Mode integration and import/export. A new character's abilities are placed on its bars on first login, stances and forms on the first side bar, newly learned spells take the first empty slot, and Blizzard's stance bar is hidden.
